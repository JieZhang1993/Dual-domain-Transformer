...
test_weights_name = "dual-domain-transformer-e200"
...
train_dataset = VaihingenDataset(data_root='./data/potsdam/train', mode='train',
                                 mosaic_ratio=0.25, transform=train_aug)

val_dataset = VaihingenDataset(data_root='./data/potsdam/test', transform=val_aug)
test_dataset = VaihingenDataset(data_root='./data/potsdam/test', transform=val_aug)
