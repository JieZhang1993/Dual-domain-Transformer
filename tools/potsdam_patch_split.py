...
def parse_args():
    ...
    parser.add_argument("--mask-dir", default="../data/potsdam/test_masks")
    parser.add_argument("--output-img-dir", default="../data/potsdam/GT/images_512")
    parser.add_argument("--output-mask-dir", default="../data/potsdam/GT/masks_512")
    parser.add_argument("--eroded", type=bool, default=False)
    parser.add_argument("--gt", type=bool, default=True)  # output RGB mask
    parser.add_argument("--rgb-image", type=bool, default=True)  # use Potsdam RGB format images
