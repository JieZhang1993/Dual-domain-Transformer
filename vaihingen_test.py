...
def get_args():
    ...
    arg("-c", "--config_path", type=Path, default='config/vaihingen/dual_domain_transformer.py', help="Path to  config")
    arg("-o", "--output_path", type=Path, default='fig_results/vaihingen/dual_domain_transformer', help="Path where to save resulting masks.")
