...
def get_args():
    ...
    arg("-c", "--config_path", type=Path, default='config/potsdam/manet.py', help="Path to  config")
    arg("-o", "--output_path", type=Path,  default='fig_results/potsdam/manet-e25', help="Path where to save resulting masks.")
    arg("-t", "--tta", help="Test time augmentation.", default=None, choices=[None, "d4", "lr"])
    arg("--rgb", help="whether output rgb images", action='store_false')
